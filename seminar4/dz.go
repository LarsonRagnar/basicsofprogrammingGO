...
type Cache interface { // интерфейс для cache с методами get и set
	Get(k string) (string, bool)
	Set(k, v string)
}

var _ Cache = (*cacheImpl)(nil) // создаем пустую переменую от инрефейса Cache с указателем
...
func main() {
	...
	fmt.Println("=== Первые запросы (из БД) ===")
